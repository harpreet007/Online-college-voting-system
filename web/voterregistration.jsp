<%-- 
    ...
    Created on : Mar 21, 2018, 12:32:25 AM
    Author     : harpreet
--%>
...
<div class="container" style="padding-top: 100px; float: left;">
  <!-- <div class="btn-group-vertical" style="float: left;">
    ...
    <div class="col-md-10"> 
      ...
      <h2><strong>Voter Registration Form</strong> </h2><br>
      </div>
   
    <form action="voterReg" method="post" class="form-horizontal control-form col-md-12" data-toggle="validator" role="form">
